...
export const Roadmap = () => (
  ...
  >
    <div className="mb-8 flex items-center justify-between">
      ...
      <a href="#" className="inline-flex items-center gap-1 text-[13px] font-medium text-accent hover:underline">
    ...
    <div className="hidden md:block">
      <div className="relative grid grid-cols-3">
        ...
        <PhaseActive />
        <PhaseLocked num={2} title="Exploration" />
        <PhaseLocked num={3} title="Mastery" dim />
      </div>
    </div>
    ...
    <div className="flex flex-col gap-8 md:hidden">
      <div className="relative">
        <div
          ...
          style={{ background: "var(--gradient-journey)" }}
        />
        <PhaseActive align="left" />
      </div>
      <PhaseLocked num={2} title="Exploration" align="left" />
      <PhaseLocked num={3} title="Mastery" dim align="left" />
    </div>
  </section>
);

const PhaseActive = ({ align = "center" }: { align?: "center" | "left" }) => (
  <div className={["relative z-10 flex flex-col gap-2", align === "left" ? "items-start pl-16" : "items-center"].join(" ")}>
    ...
    <div className={align === "left" ? "text-left" : "text-center"}>
      <div className="text-[14px] font-bold text-accent">Phase 1</div>
      <div className="text-[12px] text-text2">Foundation</div>
    </div>
    ...
    <div className="mt-1 flex items-center gap-2">
      ...
      <span className="text-[11px] font-semibold text-accent">30%</span>
    </div>
  </div>
);
