...
const Q3_SIGNALS: SigMap = {
  ...
  "designing":              { UIUX: 3, GRAPHD: 3, CONTENT: 2 },
...
const Q4_SIGNALS: SigMap = {
  ...
  "decisions":              { DATA: 2, FINTECH: 2, PM: 2 },
  "work with people":       { PM: 3, CONTENT: 3, DIGIMKT: 3, ENTREP: 2 },
  "communicate":            { CONTENT: 3, DIGIMKT: 3, PM: 2 },
  "start, lead":            { ENTREP: 5, PM: 2 },
  "grow business":          { ENTREP: 5, PM: 2, DIGIMKT: 2 },
  "research, discover":     { DATA: 3, MECHENG: 2, CYBER: 1 },
  "how things work":        { SOFTDEV: 2, MECHENG: 2, DATA: 1, CYBER: 2 },
};
...
const Q6_SIGNALS: SigMap = {
  ...
  "beautiful design":       { GRAPHD: 5, UIUX: 2 },
