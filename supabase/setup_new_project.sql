-- ============================================================================
-- WorthScope / ambition-beacon — full schema setup
-- Paste this into the Supabase SQL Editor of project ascugtetobskaiyqmnyu
-- and run it. Idempotent-ish: safe to run once on a fresh project.
-- Combines:
--   20260603190433_...sql  (tables, functions, triggers, RLS)
--   20260603190445_...sql  (function execute revokes)
-- ============================================================================
